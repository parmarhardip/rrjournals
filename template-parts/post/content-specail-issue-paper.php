			...
			<tbody>
				...
				<tr>
					<td colspan="2" style="padding: 7px 5px 0 5px">
						<span id="ar_row_ind">
						<?php //if( isset( $icp_atricle_number ) && !empty( $icp_atricle_number ) ) { ?>
							<!--<b class="arial"><?php //echo $icp_atricle_number; ?></b></span>-->
						<?php //} ?>	
						<?php //if( isset( $postcat ) && !empty( $postcat ) ) { ?>
							<!--<a href="#"><?php //echo $postcat['parent'] . ', ' . $postcat['child']; ?></a>-->
						<?php //} ?>
						<?php 
